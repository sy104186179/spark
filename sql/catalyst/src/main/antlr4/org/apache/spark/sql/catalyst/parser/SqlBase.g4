...
colType
    : identifier dataType (DEFAULT defaultValue=primaryExpression)? (COMMENT STRING)?
    ;
...
nonReserved
    ...
    | REVOKE | GRANT | LOCK | UNLOCK | MSCK | REPAIR | RECOVER | EXPORT | IMPORT | LOAD | VALUES | DEFAULT | COMMENT | ROLE
